...
export default async function AskPage({
  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-6 py-10">
      ...
      <h1 className="mt-6 text-2xl font-semibold tracking-tight">Ask Budda</h1>
      <p className="mt-1 text-sm text-muted-foreground">
        Ask anything about {product.name} — answers come from documents you've fed in.
      </p>

      <div className="mt-10 rounded-md border border-dashed bg-card/30 p-10 text-center text-sm text-muted-foreground">
        Chat UI comes in the next step.
      </div>
    </main>
  );
}
